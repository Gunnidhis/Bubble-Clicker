...
function runTimer() {
  interval_Id = setInterval(function () {
    if (timer > 0) {
      ...
      document.getElementById("panel_bottom").innerHTML = `<h1 id="game_over">Game Over <br>Your Score is ${score}</h1>`;
      console.log()
...
const audio = new Audio("./clap_music.mp3");
let audio_timer_id;
function play_music(){
  audio.play()
  audio_timer_id =setTimeout(() => {
    audio.pause()   
  }, 5000);
}
